...
const ACTIVE_ITEM_STYLES: Record<string, string> = {
  ...
  '/dashboard/leaderboard': 'border-[#004669]/18 bg-gradient-to-r from-[#004669]/18 via-[#248f8b]/10 to-transparent text-[#004669] shadow-[inset_3px_0_0_0_rgb(0,70,105),0_8px_18px_rgba(0,70,105,0.08)] dark:border-[#35a19d]/24 dark:text-[#7ddce7]',
  ...
  '/tutor/grading': 'border-[#0f5b82]/20 bg-gradient-to-r from-[#0f5b82]/16 via-[#0f5b82]/10 to-transparent text-[#0f5b82] shadow-[inset_3px_0_0_0_rgb(15,91,130),0_8px_18px_rgba(15,91,130,0.08)] dark:text-[#7ddce7]',
